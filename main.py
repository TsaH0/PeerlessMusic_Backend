...
import uvicorn
from fastapi import FastAPI, HTTPException, BackgroundTasks, Header, Cookie, Response
...
@app.delete("/api/playlists/{playlist_id}/tracks/{video_id}", response_model=PlaylistResponse)
